...
namespace RestApiLab.Models
{
    public partial class northwindContext : DbContext
    {
        ...
        public virtual DbSet<CategorySalesFor1995> CategorySalesFor1995s { get; set; }
        ...
        public virtual DbSet<ProductSalesFor1995> ProductSalesFor1995s { get; set; }
        ...
        public virtual DbSet<TenMostExpensiveProduct> TenMostExpensiveProducts { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CategorySalesFor1995>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("Category Sales for 1995");
            ...
            modelBuilder.Entity<Invoice>(entity =>
            {
                ...
                entity.Property(e => e.CustomersCompanyName)
                    .HasMaxLength(40)
                    .HasColumnName("Customers.CompanyName");
                ...
                entity.Property(e => e.ShippersCompanyName)
                    .HasMaxLength(40)
                    .HasColumnName("Shippers.CompanyName");
            ...
            modelBuilder.Entity<ProductSalesFor1995>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("Product Sales for 1995");
            ...
            modelBuilder.Entity<TenMostExpensiveProduct>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("Ten Most Expensive Products");

                entity.Property(e => e.TenMostExpensiveProducts).HasMaxLength(40);
